...
export default function EditWholesaler({handleClose}){
    const currentWholesaler = useSelector(store => store.wholesalersReducer.currentWholesaler);
    const [wholesalerName, setWholesalerName] = useState(currentWholesaler.company_name);
    ...
    return (
        <div className = 'modalContainerSmall'>
            ...
            {showAlert && <Alert severity='success'>Wholesaler successfully updated</Alert>}
